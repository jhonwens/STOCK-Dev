    ...
    <div style={{ maxWidth: 720, margin: "0 auto" }}>
      ...
      <div style={{
        ...
        <img
          ...
          alt="衡势价值"
          style={{ width: 48, height: 48, borderRadius: 11, marginBottom: 10, boxShadow: "0 4px 12px rgba(0,0,0,0.3)" }}
        />
        <div style={{ fontSize: 20, fontWeight: 700, letterSpacing: 1 }}>衡势价值</div>
